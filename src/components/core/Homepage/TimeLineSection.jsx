                        ...
                        timeline.map((element,index)=>{
                            return (
                                <div className="flex flex-row gap-6" key={index}>
                                    <div className="relative w-[50px\ h-[50px] flex items-center bg-white">
                                        <img src={element.Logo}/>
                                        <div className=" absolute border-r-2 border-dotted border-richblack-300 h-[30px] translate-y-[110%] translate-x-[500%]"></div>
                                    </div>
                                    <div>
